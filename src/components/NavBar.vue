  ...
  >
    <div class="container mx-auto px-6 flex justify-between items-center">
      ...
      >
        <div 
          v-if="isOpen" 
          class="fixed inset-0 z-50 bg-patagonia bg-opacity-[0.98] w-full h-full flex flex-col justify-center items-center"
        >
          ...
          <nav class="flex flex-col items-center space-y-8">
            <a 
              ...
              :href="link.href" 
              @click="closeMenu"
              class="font-sans text-3xl font-bold uppercase tracking-[0.2em] text-mist hover:text-clay transition-colors duration-300 hover:scale-105 transform"
            >
              {{ link.name }}
            </a>
          </nav>

          <div class="absolute bottom-12 flex items-center gap-8 opacity-80">
